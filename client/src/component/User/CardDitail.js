...
<Box sx={{m:1,p:1,marginBottom:0,paddingBottom:16}}>
  ...
  プログラマーとしてさまざまなソフトウェア開発現場に7年間勤務してきました。現在はCやJava、PHP、Rubyなど数多くの開発言語に対応可能です。特にPHPでのWEBサイト構築に自信があり、昨年は大手クライアントからの依頼により、グルメサイト、求人サイト、不動産検索サイトを制作しました。検索サイト構築では、一流のDBエンジニアと関わることが多くあり、DB設計の善し悪しによってプログラミングの手間が大幅に省けることを発見しました。
  今後は、様々な角度からプログラミングを見直し、より高機能でレスポンスのよいプログラミングができるよう技術を磨きたいと考えております。
  </Grid>
</Box>
<Divider />
